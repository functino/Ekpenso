<?php
/* SVN FILE: $Id: form.php 1 2008-05-23 23:12:34Z ageier $ */
/**
	...
	function error($field, $text = null, $options = array()) {
		...
		if ($error = $this->tagIsInvalid()) {
			...
			if ($options['wrap'] === true) {
				unset($options['wrap']);
				return $this->output(sprintf($this->Html->tags['error'], $this->_parseAttributes($options), __($error, true))); //my-fix: added getext
			} else {
				return __($error, true); //my-fix: added getext
			}
		} else {
			return null;
		}
